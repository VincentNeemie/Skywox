...
const Imagesource = './static/image/image.jpg';
const baseUrl = 'https://photo-sphere-viewer-data.netlify.app/assets/';
    ...
    plugins: [
        [PhotoSphereViewer.AutorotatePlugin, {
            autorotatePitch: '6deg',
            autorotateSpeed: '2.5rpm',
...
// adjust the size of the viewer to the window size
...
function resizeElement() {
  ...
  // Call resizeElement() once to set the initial size of the element
  resizeElement();